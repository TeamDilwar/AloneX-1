...
async def init():
    ...
    LOGGER("AloneX").info("Music Bot Started Successfully, Now Gib your girlfriend chumt to @ALONE_WAS_BOT")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("AloneX").info("Stopping Music Bot, Bhakk Bhosdike (Gaand Maraa Tu)")
